...
const optionalFields = ['phone','companyName','country','product','volume','incoterms','projectName','ticketSize','specialization','notes'];
export async function handleLeadRequest(req, webhookUrl, send = fetch) {
